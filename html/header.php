...
<head>
  ...
  <link rel="icon" href="./img/Logo_ico.png" type="image/png">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
  <title>Titulación ICO</title>
  ...
  <nav>
    <div class="nav-wrapper blue darken-4">
      ...
      <ul id="nav-desktop" class="right hide-on-med-and-down">
        ...
        <li><a href="./formulario.php" class="white-text"><i class="material-icons left">assignment</i>Registro modalidad</a></li>
      </ul>

      <ul id="nav-mobile" class="sidenav grey lighten-1">
        <li><a href="./index.php"><i class="material-icons left">home</i>Inicio</a></li>
        <li><a href="./formulario.php"><i class="material-icons left">assignment</i>Registro</a></li>
      </ul>
